...
function getMoviesByGenre(g){
    // alert(g)
    var res
    axios.get("  https://api.themoviedb.org/3/discover/tv?api_key=a952fd258f7e77da897ce3bd96c75efe&page=1&include_adult=false&page=1&with_genres="+g)
...
function display(element){
    ...
    <div class="col-span-5 ">
        <div class="grid grid-rows-3">
            <div id="title1" class="pt-4 text-2xl">`+element.name+`</div>
            <div id="overview1" >`+element.overview.substring(0,150)+` ...</div>
            <div class="pt-3 text-gl">
                <label for="dateL">Release Date:`+element.first_air_date+`</label>
